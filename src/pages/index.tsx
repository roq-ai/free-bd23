  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Free - Your go-to marketplace for freelancers. Connect, apply, and secure jobs published by renowned companies. Unlock your freelance potential."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Free - Your go-to marketplace for freelancers. Connect, apply, and secure jobs published by renowned companies. Unlock your freelance potential.`}
            </Text>
            <Box
